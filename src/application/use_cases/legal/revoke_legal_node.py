...
from src.domain.enums import LegalRelationType, NodeStatus
...
class RevokeLegalNodeUseCase:
    ...
    async def execute(
        ...
        # Preserva o nó histórico intacto, apenas registrando o evento de revogação via relação e metadados
        if revoking_node_id:
